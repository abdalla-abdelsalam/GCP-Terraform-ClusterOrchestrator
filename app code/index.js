...
async function main() {
    ...
    //const uri = `mongodb://user:password@mongodb-0.mongodb,mongodb-1.mongodb,mongodb-2.mongodb/test?readPreference=nearest&replicaSet=rs0&authSource=test`;
    const uri = `mongodb://${DBuser}:${DBpass}@${DBhosts}/test?readPreference=nearest&replicaSet=rs0&authSource=test`;
